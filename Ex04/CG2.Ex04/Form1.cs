...
namespace CG2.Ex04
{
	public partial class Form1 : Form
	{
		...
		Camera camera = new Camera(500, 400)
		{
			Position = new Vector4(25, 0, 6.5),
			Target = new Vector4(0, 0, 6.5),
			zNear = 0.01,
			zFar = 100.0,
		};
		...
		public void InitSceneLight()
		{
			...
			world.Models.Add(new Sphere(lightBlue, new Vector4(0, 0, 4), 4));
